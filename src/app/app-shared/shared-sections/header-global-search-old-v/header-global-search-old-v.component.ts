...
@Component({
  selector: 'header-global-search-old-v',
  standalone: true,
  imports: [ CommonModule ,NgSelectModule, FormsModule,
    TranslateModule],
  templateUrl: './header-global-search-old-v.component.html',
  styleUrl: './header-global-search-old-v.component.scss'
})
export class HeaderGlobalSearchOldVComponent implements OnInit{
  searchWord = '';
